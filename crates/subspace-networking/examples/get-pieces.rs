...
async fn main() {
    ...
    let hashed_peer_id = subspace_networking::U256::from_big_endian(&raw_hashed_peer_id);
    ...
    let stream_future = node_1.get_pieces_by_range(hashed_peer_id.clone(), hashed_peer_id);
